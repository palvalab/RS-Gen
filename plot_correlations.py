...
amp_data   = pick.load(open(data_dir+'_data_compressed\\amp_data.dat','rb'))
dfa_data   = pick.load(open(data_dir+'_data_compressed\\dfa_data.dat','rb'))
synch_data = pick.load(open(data_dir+'_data_compressed\\synch_data.dat','rb'))
